...
export type CollectionVideosQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type CollectionVideosQuery = {
  collection?: StorefrontAPI.Maybe<{
    products: {
      nodes: Array<
        Pick<StorefrontAPI.Product, 'title' | 'onlineStoreUrl' | 'handle'> & {
          media: {
            nodes: Array<
              | (Pick<
                  StorefrontAPI.ExternalVideo,
                  'embedUrl' | 'mediaContentType'
                > & {
...
export type PredictiveSearchApiQueryVariables = StorefrontAPI.Exact<{
  query: StorefrontAPI.Scalars['String']['input'];
  limit: StorefrontAPI.Scalars['Int']['input'];
}>;

export type PredictiveSearchApiQuery = {
...
> & {
  ...
  variants: {
    nodes: Array<
      Pick<StorefrontAPI.ProductVariant, 'id' | 'weight' | 'weightUnit'>
    >;
  };
};
...
export type DeliveryPageQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;
...
> & {
  media: {
    nodes: Array<
      | (Pick<StorefrontAPI.ExternalVideo, 'embedUrl' | 'mediaContentType'> & {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CollectionVideos {\n    collection(handle: "products-with-videos") {\n      products(first: 50) {\n        nodes {\n          title\n          onlineStoreUrl\n          handle\n          media(first: 10) {\n            nodes {\n              mediaContentType\n              ... on ExternalVideo {\n                embedUrl\n                previewImage { url }\n              }\n              ... on Video {\n                sources { url mimeType }\n                previewImage { url }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: CollectionVideosQuery;
    variables: CollectionVideosQueryVariables;
  };
  '#graphql\n  query PredictiveSearchAPI($query: String!, $limit: Int!) {\n    predictiveSearch(query: $query, limit: $limit, types: PRODUCT) {\n      products {\n        id\n        title\n        handle\n        featuredImage {\n          url\n          altText\n          width\n          height\n        }\n        images(first: 1) {\n          nodes {\n            url\n            altText\n            width\n            height\n          }\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n  }\n': {
    return: PredictiveSearchAPIQuery;
    variables: PredictiveSearchAPIQueryVariables;
  };
